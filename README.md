# CRONCH 
_The tastiest serialisation library... ish_
...
you should only have to provide this information _once_. Rather than at least twice for serialisating and 
deserialsing.
...
cronch is header-only and _very_ template heavy. You have been warned.
